...
Begin VB.Form forma_vendor 
   ...
   ClientTop       =   450
   ClientWidth     =   18105
   Icon            =   "forma_vendor_callcenter.frx":0000
   LinkTopic       =   "Form2"
   ScaleHeight     =   10590
   ScaleWidth      =   18105
   ...
   Begin Project1.lvButtons_H btnexcel 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "forma_vendor_callcenter.frx":3336E
      ImgSize         =   40
      cBack           =   -2147483633
   End
   Begin Project1.lvButtons_H btnshow_dates 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "forma_vendor_callcenter.frx":3517E
      ImgSize         =   40
      cBack           =   -2147483633
   End
   Begin Project1.lvButtons_H btnsort 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "forma_vendor_callcenter.frx":37104
      ImgSize         =   40
      cBack           =   16777215
   End
   Begin Project1.lvButtons_H btnbusca 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "forma_vendor_callcenter.frx":37667
      ImgSize         =   40
      cBack           =   -2147483633
   End
   ...
   Begin RichTextLib.RichTextBox RichTextBox1 
      ...
      Enabled         =   -1  'True
      ScrollBars      =   3
      TextRTF         =   $"forma_vendor_callcenter.frx":38FCE
   End
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin Project1.lvButtons_H btnsave1 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "forma_vendor_callcenter.frx":39059
         ImgSize         =   40
         cBack           =   -2147483633
      End
      Begin Project1.lvButtons_H btnexportar 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "forma_vendor_callcenter.frx":3AD5C
         ImgSize         =   24
         cBack           =   16777215
      End
      ...
      Begin VB.PictureBox mensaje 
         ...
         Begin VB.Image Image6 
            Height          =   975
            Left            =   0
            Picture         =   "forma_vendor_callcenter.frx":3BA4E
            Top             =   600
            Width           =   1455
         End
      End
      Begin RichTextLib.RichTextBox txtturbo_quote 
         ...
         OLEDragMode     =   0
         OLEDropMode     =   1
         TextRTF         =   $"forma_vendor_callcenter.frx":3C467
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Times New Roman"
            Size            =   9
            Charset         =   0
      ...
      Begin MSFlexGridLib.MSFlexGrid grid1 
         ...
         _Version        =   393216
         BackColor       =   6025966
         BackColorFixed  =   11463931
         BackColorBkg    =   11463931
         BorderStyle     =   0
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Times New Roman"
            Size            =   6.75
      ...
      Begin Project1.lvButtons_H btnlimpia_status 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "forma_vendor_callcenter.frx":3C4EB
         ImgSize         =   40
         cBack           =   16777215
      End
      Begin Project1.lvButtons_H btnlimpia_status2 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "forma_vendor_callcenter.frx":3C93D
         ImgSize         =   40
         cBack           =   16777215
      End
      ...
      Begin Project1.lvButtons_H btnnew1 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "forma_vendor_callcenter.frx":3CD8F
         ImgSize         =   40
         cBack           =   -2147483633
      End
      Begin Project1.lvButtons_H btnsms 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "forma_vendor_callcenter.frx":3F10F
         ImgSize         =   40
         cBack           =   -2147483633
      End
      Begin Project1.lvButtons_H btntranfiere 
         ...
         Mode            =   0
         Value           =   0   'False
         Image           =   "forma_vendor_callcenter.frx":40E3B
         ImgSize         =   40
         cBack           =   -2147483633
      End
      ...
      Begin VB.Image Image3 
         Height          =   375
         Left            =   2320
         Picture         =   "forma_vendor_callcenter.frx":4128D
         Stretch         =   -1  'True
         Top             =   1560
         Width           =   285
      End
      Begin VB.Image Image2 
         Height          =   375
         Left            =   240
         Picture         =   "forma_vendor_callcenter.frx":41C4F
         Stretch         =   -1  'True
         Top             =   1560
         Width           =   375
      End
      ...
      Begin VB.Image op_cita 
         ...
         Index           =   0
         Left            =   3000
         Picture         =   "forma_vendor_callcenter.frx":427CF
         Stretch         =   -1  'True
         Top             =   2955
         Width           =   480
      End
      Begin VB.Image happy_face 
         Height          =   495
         Left            =   5880
         Picture         =   "forma_vendor_callcenter.frx":43319
         Stretch         =   -1  'True
         Top             =   3600
         Visible         =   0   'False
         Width           =   375
      ...
      Begin VB.Image btncalendar1 
         Height          =   465
         Left            =   1245
         Picture         =   "forma_vendor_callcenter.frx":43EAF
         Stretch         =   -1  'True
         Top             =   2880
         Width           =   360
      End
      Begin VB.Image imgcita3 
         Height          =   375
         Left            =   5880
         Picture         =   "forma_vendor_callcenter.frx":44A41
         Stretch         =   -1  'True
         Top             =   6240
         Visible         =   0   'False
         Width           =   375
      ...
      Begin VB.Image imgcita3b 
         Height          =   375
         Left            =   5400
         Picture         =   "forma_vendor_callcenter.frx":45023
         Stretch         =   -1  'True
         Top             =   6240
         Visible         =   0   'False
         Width           =   375
      ...
      Begin VB.Image imgcita2b 
         Height          =   495
         Left            =   5640
         Picture         =   "forma_vendor_callcenter.frx":45BA0
         Stretch         =   -1  'True
         Top             =   6240
         Visible         =   0   'False
         Width           =   375
      ...
      Begin VB.Image imgcita2 
         Height          =   480
         Left            =   5640
         Picture         =   "forma_vendor_callcenter.frx":46724
         Stretch         =   -1  'True
         Top             =   6120
         Visible         =   0   'False
         Width           =   405
      ...
      Begin VB.Image imgcita1 
         Height          =   375
         Left            =   5880
         Picture         =   "forma_vendor_callcenter.frx":46D14
         Stretch         =   -1  'True
         Top             =   6240
         Visible         =   0   'False
         Width           =   375
      ...
      Begin VB.Image imgcita1b 
         Height          =   360
         Left            =   6000
         Picture         =   "forma_vendor_callcenter.frx":472C7
         Stretch         =   -1  'True
         Top             =   6240
         Visible         =   0   'False
         Width           =   405
      ...
      Begin VB.Image op_cita 
         ...
         Index           =   2
         Left            =   4200
         Picture         =   "forma_vendor_callcenter.frx":47E11
         Stretch         =   -1  'True
         Top             =   2955
         Width           =   480
      End
      Begin VB.Image op_cita 
         ...
         Index           =   1
         Left            =   3600
         Picture         =   "forma_vendor_callcenter.frx":483F3
         Stretch         =   -1  'True
         Top             =   2955
         Width           =   480
      End
   ...
   Begin Project1.lvButtons_H btncallcenter 
      ...
      Value           =   0   'False
      ImgAlign        =   4
      Image           =   "forma_vendor_callcenter.frx":489E3
      ImgSize         =   48
      Enabled         =   0   'False
      cBack           =   -2147483633
   End
   Begin Project1.lvButtons_H btnvendor 
      ...
      Mode            =   2
      Value           =   -1  'True
      Image           =   "forma_vendor_callcenter.frx":4A45A
      ImgSize         =   48
      cBack           =   -2147483633
   End
   Begin Project1.lvButtons_H btnReports 
      ...
      Mode            =   2
      Value           =   0   'False
      Image           =   "forma_vendor_callcenter.frx":4D932
      ImgSize         =   48
      cBack           =   -2147483633
   End
   Begin Project1.lvButtons_H btnemployees 
      ...
      Mode            =   2
      Value           =   0   'False
      Image           =   "forma_vendor_callcenter.frx":4FECE
      ImgSize         =   48
      cBack           =   -2147483633
   End
   Begin Project1.lvButtons_H btnOffices 
      ...
      Mode            =   2
      Value           =   0   'False
      Image           =   "forma_vendor_callcenter.frx":5215F
      ImgSize         =   48
      cBack           =   -2147483633
   End
   Begin Project1.lvButtons_H btnexit 
      ...
      Mode            =   0
      Value           =   0   'False
      Image           =   "forma_vendor_callcenter.frx":543E7
      ImgSize         =   48
      cBack           =   14737632
   End
   ...
   Begin VB.Image Image5 
      Height          =   735
      Left            =   3360
      Picture         =   "forma_vendor_callcenter.frx":565D6
      Stretch         =   -1  'True
      Top             =   8640
      Width           =   1215
   End
   ...
   End
End
Attribute VB_Name = "forma_vendor"
...
' factura$ = "hna1970@yahoo.com.mx;hector@navaz.com.mx"
  ...
  ' carga el campo de ciudad
    ...
    direccion_completa$ = RTrim(direccion1$) + ", " + RTrim(ciudad1$) + ", " + RTrim(estado1$) + ", " + RTrim(cp1$)
      ...
      msg2$ = "</p> Hello, " + txtcliente1.Text + "</p>"
 ...
 '     msg2$ = "</p>" + "   " + "</p>"
  ...
  '    Unlock #nf2
      ...
      fecha_cita$ = Format(lblfecha_cita1.Caption, "mmmm dd")
      If UCase(lbloficina.Caption) = "COM" Or UCase(lbloficina.Caption) = "PHO" Then
         msg2$ = "</p> We are sending you a reminder of your appointment that will be on " + fecha_cita$ + " at " + cbo_time1.List(cbo_time1.ListIndex) + ". </p>"
      Else
         msg2$ = "</p> We are sending you a reminder of your appointment that will be on " + fecha_cita$ + " at " + cbo_time1.List(cbo_time1.ListIndex) + ", in our office located at: </p>"
      End If
      ...
      If UCase(lbloficina.Caption) = "COM" Or UCase(lbloficina.Caption) = "PHO" Then
        msg2$ = "</p> Please, call to " + telefono1$ + ". </p>"
      Else

         msg2$ = "</p> >>" + direccion_completa$ + "<< </p>"
      End If
      ...
      If txtturbo_quote.Text <> "" Then
         msg2$ = "</p> Your quote number is " + txtturbo_quote.Text + "." + "</p>"
...
On Error Resume Next
   ...
   ' cambia formato de telefono
    ...
    Format(carrier, "0#") + "', quote_turborater='" + txtturbo_quote.Text + "', region='" + Format(region_de_oficina, "00") + "', hora_citax='" + lbltime_appointment1.Caption + "', fecha_citax='" + lblappointment1.Caption + "', fecha_creacion='" + Left(lbldate1.Caption, 10) + "' where idcita='" + Format(id_cita, "#####0") + "'"
...
On Error Resume Next
 ...
 If regional <= 0 Then
    ...
    If busqueda_activada = 0 Then
        ...
        Case 4
              sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks, comentario, comentario2, csr, quote_turborater FROM citas WHERE oficina='" + oficina_autorizada$ + "'  and (fecha_cita1='" + fecha_hoy$ + "') order by " + ordena_por$ + " asc"
    ...
    Else
         ...
         Case 1
           sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks,  comentario, comentario2, csr, quote_turborater FROM citas WHERE oficina='" + oficina_autorizada$ + "'  and (cliente like '%" + UCase(txtbusca.Text) + "%') order by " + ordena_por$ + " asc"
         Case 2
           
           
           sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks,  comentario, comentario2, csr, quote_turborater FROM citas WHERE oficina='" + oficina_autorizada$ + "'  and (telefono like '%" + UCase(txtbusca.Text) + "%') order by " + ordena_por$ + " asc"
         Case 3
           sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks,  comentario, comentario2, csr, quote_turborater FROM citas WHERE oficina='" + oficina_autorizada$ + "'  and (quote='" + UCase(txtbusca.Text) + "') order by " + ordena_por$ + " asc"
           
         Case 4
             sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks,  comentario, comentario2, csr, quote_turborater FROM citas WHERE oficina='" + oficina_autorizada$ + "'  and (direccion like '%" + UCase(txtbusca.Text) + "%') order by " + ordena_por$ + " asc"
 ...
 Else
   ...
   If busqueda_activada = 0 Then
        ...
        Select Case fecha_busqueda
        Case 0
              sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks,  comentario, comentario2, csr, quote_turborater FROM citas WHERE region='" + Format(region_zona, "#0") + "'  and (fecha_creacion='" + fecha_hoy$ + "') order by " + ordena_por$ + " asc"
        Case 1
              dia_ayer = Val(Format(Now, "y"))
              fecha_ayer$ = Format(dia_ayer, "mm/dd")
              fecha_ayer$ = fecha_ayer$ + "/" + Format(Now, "yyyy")
              
              sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks, comentario, comentario2, csr, quote_turborater FROM citas WHERE region='" + Format(region_zona, "#0") + "'  and (fecha_cita1='" + fecha_ayer$ + "') order by " + ordena_por$ + " asc"
        Case 2
        dia_manana = Val(Format(Now, "y")) + 2
              fecha_manana$ = Format(dia_manana, "mm/dd")
              fecha_manana$ = fecha_manana$ + "/" + Format(Now, "yyyy")
              
              sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks,  comentario, comentario2, csr, quote_turborater FROM citas WHERE region='" + Format(region_zona, "#0") + "'  and (fecha_cita1='" + fecha_manana$ + "') order by " + ordena_por$ + " asc"
        ...
        Case 4
              sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks,  comentario, comentario2, csr, quote_turborater FROM citas WHERE region='" + Format(region_zona, "#0") + "'  and (fecha_cita1='" + fecha_hoy$ + "') order by " + ordena_por$ + " asc"
    ...
    Else
         ...
         Select Case busqueda_activada
         Case 1
           sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks,  comentario, comentario2, csr, quote_turborater FROM citas WHERE region='" + Format(region_zona, "#0") + "'  and (cliente like '%" + UCase(txtbusca.Text) + "%') order by " + ordena_por$ + " asc"
         Case 2
           
           
           sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks,  comentario, comentario2, csr, quote_turborater FROM citas WHERE region='" + Format(region_zona, "#0") + "'  and (telefono like '%" + UCase(txtbusca.Text) + "%') order by " + ordena_por$ + " asc"
         Case 3
           sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks,  comentario, comentario2, csr, quote_turborater FROM citas WHERE region='" + Format(region_zona, "#0") + "'  and (quote='" + UCase(txtbusca.Text) + "') order by " + ordena_por$ + " asc"
           
         Case 4
             sSelect = "SELECT idcita, quote, agente, oficina,fecha,fecha_cita1, hora_cita1,status_gral,cliente,fecha_citax, hora_citax,fecha_cita2, hora_cita2, fecha_cita3,hora_cita3, telefono, direccion, ciudad, estado,cp, recibo, vendor, hwks,  comentario, comentario2, csr, quote_turborater FROM citas WHERE region='" + Format(region_zona, "#0") + "'  and (direccion like '%" + UCase(txtbusca.Text) + "%') order by " + ordena_por$ + " asc"
...
On Error Resume Next
If cbostatus_gral1.Enabled = True Then
...
verifica = 0
Select Case UCase(lblagente.Caption)
Case "COMP"
  n$ = "CPT"
  verifica = 1
Case "COVI"
...
If verifica = 1 Then
    ...
    sSelect = "SELECT nombre FROM oficina where abreviatura='" + n$ + "'"
    ...
    For t = 0 To cbo_Oficina1.ListCount - 1
       If UCase(cbo_Oficina1.List(t)) = UCase(oficina$) Then
           cbo_Oficina1.ListIndex = t
           Exit For
       End If
    Next t
...
If txtCSR1.Text = "" Then
   MsgBox "You need to type the Customer Service Representative (CSR)", 64, "Attention"
   Exit Sub
End If
...
' asigna el ultimo quote
   ...
   lbldate1.Caption = Format(Now, "mm/dd/yyyy") + " " + Format(Now, "hh:mm am/pm")
    ...
    "', '" + txtcelular.Text + "', '" + Format(carrier, "0#") + "', '" + txtturbo_quote.Text + "', '" + Format(region_de_oficina, "00") + "', '" + lbltime_appointment1.Caption + "', '" + lblappointment1.Caption + "', '" + Left(lbldate1.Caption, 10) + "')"
...
On Error Resume Next
    ...
    If lblfecha_cita1.Caption = "" Then
      ...
      End If
    Else
      If (R$ < fecha_guardada$ Or Val(Right(R$, 4)) < Val(Right(fecha_guardada$, 4))) And lblquote1.Caption <> "" Then
          MsgBox "Cannot select a date prior to saved date", 16, "Attention"
          GoTo salida
      ElseIf (R$ < Format(Now, "mm/dd/yyyy") Or Val(Right(R$, 4)) < Val(Format(Now, "yyyy"))) And lblquote1.Caption = "" Then
          MsgBox "Cannot select a date prior to today", 16, "Attention"
          GoTo salida
          
      ElseIf (R$ < lblappointment2.Caption Or Val(Right(R$, 4)) < Val(Right(lblappointment2.Caption, 4))) And lblquote1.Caption <> "" And cita = 1 Then
          MsgBox "Cannot select a date prior to second date", 16, "Attention"
          GoTo salida
          
      ElseIf (R$ < lblappointment3.Caption Or Val(Right(R$, 4)) < Val(Right(lblappointment3.Caption, 4))) And lblquote1.Caption <> "" And cita = 2 Then
...
'If Dir$("f:\citas") <> "" Then
  ...
  nf = FreeFile
  Open "\\192.168.84.215\callcenter\citas" For Input Shared As #nf
  Lock #nf
  Line Input #nf, d$
  Unlock #nf
  Close #nf
  ...
  If d$ <> fecha_hoy$ Then
      nf = FreeFile
      Open "\\192.168.84.215\callcenter\citas" For Output Shared As #nf
      Lock #nf
      Print #nf, fecha_hoy$
      Unlock #nf
      Close #nf
...
If lblagente.Caption = UCase("COMP") Or lblagente.Caption = UCase("COVI") Or lblagente.Caption = UCase("ECHO") Or lblagente.Caption = UCase("FLOR") Or lblagente.Caption = UCase("HAVEN") Or lblagente.Caption = UCase("BERN") Or lblagente.Caption = UCase("SANT") Or lblagente.Caption = UCase("POND") Or lblagente.Caption = UCase("WHIT") Then
...
'Llenar las filas
      ...
      'Llenar las filas
       For j = 1 To filas 'comenzamos en 1 porque el encabezado no se vuelve a llenar
              ...
              If Rs.Fields(0).value <> "" Then cbo_Oficina1.AddItem Rs.Fields(0).value + " " + Rs.Fields(1).value
       ...
       total_reg = cbo_Oficina1.ListCount
...
Private Sub op_serach_Click(Index As Integer)
...
msg.Caption = "sending appointment reminders for today"
mensaje.Visible = True
Refresh
...
For w = 1 To grid1.rows - 1
  grid1.Row = w
  grid1.Col = 1
  quote1 = Val(grid1.Text)
  
  grid1_Click
  
    Set Rs = New ADODB.Recordset
    sSelect = "SELECT celular From citas where quote='" + Format(quote1, "#####0") + "'"
    ' Abrir el recordset de forma sin especificar, porque vamos a cambiar datos
    Rs.Open sSelect, base, adOpenUnspecified
    celular$ = Rs(0)
    Rs.Close
    ...
    Set Rs = New ADODB.Recordset
    sSelect = "SELECT sms From citas where quote='" + Format(quote1, "#####0") + "'"
    ' Abrir el recordset de forma sin especificar, porque vamos a cambiar datos
    Rs.Open sSelect, base, adOpenUnspecified
    carrier = Rs(0)
    Rs.Close
...
' quita los simbolos no numericos al celular
R$ = ""
For Y = 1 To Len(celular$)
   If Asc(Mid$(celular$, Y, 1)) >= Asc("0") And Asc(Mid$(celular$, Y, 1)) <= Asc("9") Then
       R$ = R$ + Mid$(celular$, Y, 1)
   End If
